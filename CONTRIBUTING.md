...
For a full local stack (operator, gateway, BFF, frontend, and a kind
cluster running Jenkins controllers), see
[`docs/install/local-development.md`](docs/install/local-development.md).
