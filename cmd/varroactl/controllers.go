...
func describePhase(d client.ComponentsSchemasControllerDetail) {
	...
	if d.Hibernated != nil && *d.Hibernated {
		_, _ = fmt.Fprintln(os.Stdout, "Hibernated:\ttrue")
		if d.HibernatedAt != nil && *d.HibernatedAt != "" {
			_, _ = fmt.Fprintf(os.Stdout, "Hibernated At:\t%s\n", *d.HibernatedAt)
		}
	}
}
