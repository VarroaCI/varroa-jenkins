...
func init() {
	...
	registerContractCases(
		...
		contractCase{Name: "createController-201", Method: "POST", Path: "/api/v1/clusters/core/controllers/test-ns", Claims: adminClaims, Body: map[string]interface{}{"metadata": map[string]interface{}{"name": "contract-created"}, "spec": map[string]interface{}{"version": "2.555"}}, WantStatus: http.StatusCreated},
		...
		contractCase{Name: "hibernateController-503", Method: "POST", Path: "/api/v1/clusters/core/controllers/test-ns/missing/hibernate", Claims: adminClaims, WantStatus: http.StatusServiceUnavailable},
		contractCase{Name: "wakeController-503", Method: "POST", Path: "/api/v1/clusters/core/controllers/test-ns/missing/wake", Claims: adminClaims, WantStatus: http.StatusServiceUnavailable},
