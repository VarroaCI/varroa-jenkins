...
func (s *stubClient) ApplyControllerSpecSSA(_ context.Context, _, _ string, _ map[string]any, _ string, _ bool) (*v1alpha1.Controller, error) {
	return nil, nil
}
func (s *stubClient) TransitionPowerState(_ context.Context, name, namespace, from, to string) (bool, error) {
	return false, nil
}
