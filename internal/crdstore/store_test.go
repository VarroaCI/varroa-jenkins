...
func TestRoundTrip_Namespaced(t *testing.T) {
	...
	want := &v1alpha1.Controller{
		...
		Spec:       v1alpha1.ControllerSpec{Namespace: "target-ns", Version: "2.479.1"},
	}
	MustSeed(f, want)
	...
	if got.Spec.Namespace != want.Spec.Namespace {
		t.Errorf("spec namespace = %q, want %q", got.Spec.Namespace, want.Spec.Namespace)
	}
}
...
func TestApply_CreatesWhenAbsent(t *testing.T) {
	...
	obj := &v1alpha1.Controller{
		...
		Spec:       v1alpha1.ControllerSpec{Namespace: "target", Version: "1.0"},
	}
...
func TestApply_UpdatesWhenExists(t *testing.T) {
	...
	obj := &v1alpha1.Controller{
		ObjectMeta: metav1.ObjectMeta{Name: "ctrl", Namespace: "ns"},
		Spec:       v1alpha1.ControllerSpec{Namespace: "target", Version: "2.0"},
	}
	if err := Apply(ctx, f, obj); err != nil {
		t.Fatalf("Apply: %v", err)
	}
...
func TestList_LabelSelector(t *testing.T) {
	...
	a := &v1alpha1.Controller{
		...
		Spec:       v1alpha1.ControllerSpec{Namespace: "ns", Version: "1.0"},
	}
	b := &v1alpha1.Controller{
		ObjectMeta: metav1.ObjectMeta{Name: "b", Namespace: "ns", Labels: map[string]string{"env": "dev"}},
		Spec:       v1alpha1.ControllerSpec{Namespace: "ns", Version: "2.0"},
	}
	MustSeed(f, a, b)
...
func TestList_CrossNamespace(t *testing.T) {
	...
	a := &v1alpha1.Controller{
		...
		Spec:       v1alpha1.ControllerSpec{Namespace: "ns1", Version: "1.0"},
	}
	b := &v1alpha1.Controller{
		ObjectMeta: metav1.ObjectMeta{Name: "b", Namespace: "ns2"},
		Spec:       v1alpha1.ControllerSpec{Namespace: "ns2", Version: "2.0"},
	}
	MustSeed(f, a, b)
...
func TestFailNext_SurfacesError(t *testing.T) {
	...
	MustSeed(f, &v1alpha1.Controller{
		...
		Spec:       v1alpha1.ControllerSpec{Namespace: "target"},
	})
